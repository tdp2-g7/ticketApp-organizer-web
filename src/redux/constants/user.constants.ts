...
export const USER_ON_EDIT_PROFILE_REQUESTED = 'USER_ON_EDIT_PROFILE_REQUESTED';
export const USER_ON_EDIT_PROFILE_SUCCEEDED = 'USER_ON_EDIT_PROFILE_SUCCEEDED';
export const USER_ON_EDIT_PROFILE_FAILED = 'USER_ON_EDIT_PROFILE_FAILED';
